...
See the [Installing CKEditor with Package Managers](https://docs.ckeditor.com/#!/guide/dev_package_managers) article for more details about installing CKEditor with Bower and Composer.
