...
class Omeka_Application extends Zend_Application
{
    ...
    public function initialize()
    {
        try {
            ...
            $message .= 'Please consult the <a href="https://omeka.org/codex/Upgrading">Upgrading</a> page on the Omeka codex, and <a href="https://omeka.org/files/omeka-1.2.1.zip">Downlodad Omeka 1.2.1</a>';
