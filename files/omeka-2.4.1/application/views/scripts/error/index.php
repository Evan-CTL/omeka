    ...
    <div class="container container-sixteen">
        <div id="content" class="ten columns offset-by-three">
            ...
            <?php if ($displayError): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <p><?php echo __('To learn how to see more detailed information about this error, see the Omeka Codex page on <a href="https://omeka.org/codex/Retrieving_error_messages">retrieving error messages</a>.'); ?>
                </p>
            <?php endif; ?>
        </div>
    </div>
